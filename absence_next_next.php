        ...
        while ($lg = mysqli_fetch_array($req)) {
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="radio" name="abs[<?php echo $lg['id_eleve']; ?>]" value="abs" required>
                    <label for="">PRESENT</label>
                    <input type="radio" name="abs[<?php echo $lg['id_eleve']; ?>]" value="pre" required>
                </td>
            </tr>
            <?php
        }
